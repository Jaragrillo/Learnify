      ...
      <main>
        ...
        <section>
          <div className='mt-10 p-10 bg-gradient-to-l from-[#34ADDA] via-30% via-[#1E88C6] to-[#0E4472]'>
              ...
              <div className="group text-white text-5xl mb-10 m-auto block italic w-fit relative">
        ...
        <section className='h-screen relative'>
          <div className='p-10 absolute top-0 bottom-0 right-0 left-0 m-auto h-fit'>
