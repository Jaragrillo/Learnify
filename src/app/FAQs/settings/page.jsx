...
import settingsFaqs from '@/utils/FAQs/settingsFaqsData.json'
    ...
    return (
        <>
            <section className="p-10">
                <h3 className="text-2xl sm:text-3xl text-[#0D1D5F] mb-10">Sobre la cuenta y configuración</h3>
                <div>
                    {settingsFaqs.settings.map((faq, index) => (
