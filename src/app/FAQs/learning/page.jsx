...
import learningFaqs from '@/utils/FAQs/learningFaqsData.json'
  ...
  return (
    <>
      <section className="p-10">
        <h3 className="text-2xl sm:text-3xl text-[#0D1D5F] mb-10">Sobre el aprendizaje en Learnify</h3>
        <div>
          {learningFaqs.learning.map((faq, index) => (
