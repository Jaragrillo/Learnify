    ...
    <>
        <main>
            <section className='p-10'>
                <h2 className='text-4xl text-[#0D1D5F]'>Explora Nuestras Categorías</h2>
                <p className='text-2xl text-[#0D1D5F] font-light max-w-[600px]'>Descubre una amplia gama de cursos en diversas áreas de conocimiento.</p>
            ...
            <section className='bg-gradient-to-l from-[#34ADDA] via-30% via-[#1E88C6] to-[#0E4472] px-10 py-20'>
                ...
                <div className='flex justify-between'>
                    <div className='w-[370px] h-[375px] bg-white shadow-lg shadow-black/60 p-5'>
                        ...
                        <p className='text-xl text-justify font-light text-[#0D1D5F] mb-5'>Aprende lenguajes como Python, JavaScript y más para desarrollar software, sitios web y aplicaciones móviles.</p>
                    ...
                    <div className='w-[370px] h-[375px] bg-white shadow-lg shadow-black/60 p-5'>
                        ...
                        <p className='text-xl text-justify font-light text-[#0D1D5F] mb-5'>Explora diseño gráfico, UX/UI y herramientas creativas para transformar ideas en vivencias visuales impactantes.</p>
                    ...
                    <div className='w-[370px] h-[375px] bg-white shadow-lg shadow-black/60 p-5'>
                        ...
                        <p className='text-xl text-justify font-light text-[#0D1D5F] mb-5'>Domina conceptos clave, desde álgebra básica hasta cálculo avanzado, y aplica la lógica en problemas del mundo real.</p>
            ...
            <section className='px-10 py-20'>
                <h2 className='text-4xl text-center text-[#0D1D5F]'>Preguntas frecuentes</h2>
                <div>
                    faqs section
                </div>
            </section>
