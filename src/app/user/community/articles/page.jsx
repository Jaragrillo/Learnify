    ...
    return (
      <>
        <section className="p-10">
          ...
          <div className='w-full flex flex-wrap gap-5 justify-center lg:justify-between'>
            {
              articlesData.articles.map((article, index) => (
                <div key={index} className='bg-[#cee4f1] relative shadow-lg shadow-black/50 w-[600px] h-[500px]'>
                  ...
                  <div className='p-5'>
                    <h4 className='text-lg text-justify sm:text-2xl sm:text-left font-medium'>{article.title}</h4>
                    ...
                    <div className='flex justify-between items-center absolute w-11/12 bottom-5'>
                      ...
                      <Link href={`/user/community/articles/${article.article_id}`} className='text-lg sm:text-2xl hover:text-[#0B78B8]'>Leer más →</Link>
                    </div>
                  </div>
                </div>
              ))
