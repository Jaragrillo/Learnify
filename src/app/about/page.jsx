      ...
      <main>
            ...
            <div className="relative wrap overflow-hidden h-full">
              ...
              <div className="mb-8 flex justify-between items-center w-full right-timeline">
                ...
                <div className="order-1 bg-white rounded-lg shadow-xl w-5/12 px-6 py-4">
                  <h3 className="mb-3 font-medium text-4xl bg-gradient-to-b from-[#34ADDA] via-30% via-[#1E88C6] to-[#0E4472] text-transparent bg-clip-text">Misión</h3>
                  <p className="text-xl font-light text-justify tracking-wid text-opacity-90">La misión de Learnify es ayudar a las personas a vivir de sus pasiones. Esto se logra proporcionando un ecosistema completo de soluciones seguras e integradas que permiten a los creadores de contenido crear, vender y escalar sus cursos en línea.</p>
                </div>
              </div>
              ...
              <div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
                ...
                <div className="order-1 relative bg-white rounded-lg shadow-xl w-5/12 px-6 py-4">
                  <h3 className="mb-3 font-medium text-4xl bg-gradient-to-b from-[#34ADDA] via-30% via-[#1E88C6] to-[#0E4472] text-transparent bg-clip-text">Camino</h3>
                  <p className="text-xl font-light text-justify tracking-wide text-opacity-90">El camino de Learnify se basa en varios pilares fundamentales que le permitirán crecer y consolidarse como una plataforma clave para la educación en línea.</p>
                
                  {isExpanded && (
                    <ul className="mt-4">
                      <li className='text-xl font-light text-justify mb-3'>
              ...
              <div className="mb-8 flex justify-between items-center w-full right-timeline">
                ...
                <div className="order-1 bg-white rounded-lg shadow-xl w-5/12 px-6 py-4">
                  <h3 className="mb-3 font-medium text-4xl bg-gradient-to-b from-[#34ADDA] via-30% via-[#1E88C6] to-[#0E4472] text-transparent bg-clip-text">Visión</h3>
                  <p className="text-xl font-light text-justify tracking-wide text-opacity-90">La visión de Learnify es ser una plataforma accesible y confiable para la creación y distribución de cursos en línea. Buscamos ofrecer herramientas intuitivas y eficaces para que cualquier persona pueda compartir su conocimiento y alcanzar a su audiencia.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className='py-24 px-10' id='ourDifferentiators'>
          ...
          <div className='flex flex-wrap justify-around mb-10 gap-10'>
            <div className='bg-gradient-to-b from-[#5AC8EC] via-30% via-[#3AA5D8] to-[#0A355A] text-white rounded-lg shadow-lg shadow-black/60 w-[525px] h-[350px] p-5'>
              ...
              <p className='font-light text-xl my-5 text-justify'>Accede a una amplia gama de temas y conocimientos impartidos por expertos de todo el mundo.</p>
              <div>
                <div className='flex items-center gap-1'>
                  <Image 
                    ...
                    className=""
                  />
                  <p className='text-xl'>Cursos en más de 100 temas</p>
                </div>
                <div className='flex items-center gap-1'>
                  <Image 
                    src="/svg/check.svg" 
                    ...
                    className=""
                  />
                  <p className='text-xl'>Nuevo contenido semanalmente</p>
                </div>
                <div className='flex items-center gap-1'>
                  <Image 
                    src="/svg/check.svg" 
                    ...
                    className=""
                  />
                  <p className='text-xl'>Aprende de profesionales del sector</p>
                </div>
              </div>
            </div>
            <div className='bg-gradient-to-b from-[#5AC8EC] via-30% via-[#3AA5D8] to-[#0A355A] text-white rounded-lg shadow-lg shadow-black/60 w-[525px] h-[350px] p-5'>
              ...
              <p className='font-light text-xl my-5 text-justify'>Únete a una vibrante comunidad de estudiantes y educadores que fomenta la colaboración y el crecimiento.</p>
              <div>
                <div className='flex items-center gap-1'>
                  <Image 
                    src="/svg/check.svg" 
                    ...
                    className=""
                  />
                  <p className='text-xl'>Participa en foros de discusión</p>
                </div>
                <div className='flex items-center gap-1'>
                  <Image 
                    src="/svg/check.svg" 
                    ...
                    className=""
                  />
                  <p className='text-xl'>Involúcrate en el aprendizaje entre iguales </p>
                </div>
                <div className='flex items-center gap-1'>
                  <Image 
                    src="/svg/check.svg" 
                    ...
                    className=""
                  />
                  <p className='text-xl'>Relaciónate con personas de ideas afines</p>
                </div>
              </div>
            </div>
          </div>
          <div className='flex flex-wrap justify-around gap-10'>
            <div className='bg-gradient-to-b from-[#5AC8EC] via-30% via-[#3AA5D8] to-[#0A355A] text-white rounded-lg shadow-lg shadow-black/60 w-[525px] h-[350px] p-5'>
              ...
              <p className='font-light text-xl my-5 text-justify'>Crea y vende tus propios, convirtiendo tu experiencia en un negocio rentable.</p>
              <div>
                <div className='flex items-center gap-1'>
                  <Image 
                    src="/svg/check.svg" 
                    ...
                    className=""
                  />
                  <p className='text-xl'>Establece tus propios precios</p>
                </div>
                <div className='flex items-center gap-1'>
                  <Image 
                    src="/svg/check.svg" 
                    ...
                    className=""
                  />
                  <p className='text-xl'>Obtén ingresos de las matrículas de tus aprendices</p>
                </div>
                <div className='flex items-center gap-1'>
                  <Image 
                    src="/svg/check.svg" 
                    ...
                    className=""
                  />
                  <p className='text-xl'>Recibe soporte en la creación y publicitación de cursos</p>
                </div>
              </div>
            </div>
            <div className='bg-gradient-to-b from-[#5AC8EC] via-30% via-[#3AA5D8] to-[#0A355A] text-white rounded-lg shadow-lg shadow-black/60 w-[525px] h-[350px] p-5'>
              ...
              <p className='font-light text-xl my-5 text-justify'>Nuestro proceso de revisión garantiza que todos los contenidos cumplen normas educativas exigentes.</p>
              <div>
                <div className='flex items-center gap-1'>
                  <Image 
                    src="/svg/check.svg" 
                    ...
                    className=""
                  />
                  <p className='text-xl'>Riguroso proceso de revisión de contenidos</p>
                </div>
                <div className='flex items-center gap-1'>
                  <Image 
                    src="/svg/check.svg" 
                    ...
                    className=""
                  />
                  <p className='text-xl'>Actualizaciones periódicas para mantener todo al día</p>
                </div>
                <div className='flex items-center gap-1'>
                  <Image 
                    src="/svg/check.svg" 
                    ...
                    className=""
                  />
                  <p className='text-xl'>Contenidos certificados en alta calidad</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="bg-white p-5 py-10 rounded-lg shadow-md shadow-white/60 text-left text-[#070E2B] w-[300px] sm:w-[510px] mx-auto">
                  ...
                  <div className='flex items-center mb-5 gap-2'>
                    <Image 
                      ...
                      className="bg-blue-500/50 p-1 rounded-xl"
                    />
                    <p className='text-xl'>Crea y sube tu contenido.</p>
                  </div>
                  <div className='flex items-center mb-5 gap-2'>
                    <Image 
                      ...
                      className="bg-blue-500/50 p-1 rounded-xl"
                    />
                    <p className='text-xl'>Establece el precio y pública tu curso.</p>
                  </div>
                  <div className='flex items-center mb-5 gap-2'>
                    <Image 
                      src="/svg/teacher.svg" 
                      ...
                      className="bg-blue-500/50 p-1 rounded-xl"
                    />
                    <p className='text-xl'>Sé constante, constancia = ingresos</p>
                  </div>
                  <p className='mb-5 text-xl text-center'>¡Comienza tu viaje como educador en Learnify hoy y convierte tu experiencia en ingresos!</p>
        ...
        <section>
          ...
          <div className='text-[#0D1D5F]'>
            <h2 className='text-4xl text-center font-semibold mb-2'>¿Listo para Comenzar tu Viaje de Aprendizaje?</h2>
            <p className='text-2xl text-center font-medium mb-10'>Únete a Learnify hoy y desbloquea un mundo de conocimiento a tu alcance.</p>
